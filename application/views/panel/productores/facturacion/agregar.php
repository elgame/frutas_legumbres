<div id="content" class="span10">
  ...
  <div>
    <ul class="breadcrumb">
      ...
      <li>
        <a href="<?php echo base_url('panel/productoresfac/?'.String::getVarsLink(array('id')) ); ?>">Facturación</a> <span class="divider">/</span>
      </li>
      <li>
        Agregar
      </li>
  ...
  <div class="row-fluid">
    <div class="box span12">
      <div class="box-header well" data-original-title>
        <h2><i class="icon-file"></i> Agregar Factura</h2>
        <div class="box-icon">
          <a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
        </div>
      </div>
      <div class="box-content">
        <form class="form-horizontal" action="<?php echo base_url('panel/productoresfac/agregar/?'.String::getVarsLink(array('msg')) ); ?>" method="POST" id="form">
          ...
          <div class="row-fluid">
            <div class="span6">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="dproductor" class="span9" id="dproductor" value="<?php echo set_value('dproductor', $nombre_fiscal); ?>" size="73" autofocus>
                  <input type="hidden" name="did_productor" id="did_productor" value="<?php echo set_value('did_productor', $id_productor); ?>">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="dcliente" class="span9" id="dcliente" value="<?php echo set_value('dcliente', $cliente); ?>" size="73">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="dcliente_rfc" class="span9" id="dcliente_rfc" value="<?php echo set_value('dcliente_rfc', $cliente_rfc); ?>" size="25">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="dcliente_domici" class="span9" id="dcliente_domici" value="<?php echo set_value('dcliente_domici', $cliente_domic1); ?>" size="65">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="dcliente_ciudad" class="span9" id="dcliente_ciudad" value="<?php echo set_value('dcliente_ciudad', $cliente_domic2); ?>" size="25">
                </div>
              </div>
            </div>
          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <div class="span5">
                ...
                <div class="input-prepend input-append" style="margin-top:10px;"><span class="add-on">Medida</span><input class="input-mini prod" name="dmedida" id="dmedida" type="text" value="Unidad"></div>
