    <div id="content" class="span10">
      ...
      <div>
        <ul class="breadcrumb">
          ...
          <li>
            <a href="<?php echo base_url('panel/productores/'); ?>">Dueños Huertas</a> <span class="divider">/</span>
          </li>
          <li>Modificar</li>
        </ul>
      </div>

      <form action="<?php echo base_url('panel/duenios_huertas/modificar/?'.String::getVarsLink(array('msg'))); ?>" method="post"
                    ...
                    <div class="control-group req_field">
                      ...
                      <div class="controls">
                        <input type="text" name="dnombre" id="dnombre" class="span12"
                          value="<?php echo (isset($info['info']->nombre)? $info['info']->nombre: ''); ?>" maxlength="120" autofocus>
                      </div>
                    </div>
