    <div id="content" class="span10">
      ...
      <form action="<?php echo base_url('panel/empacadores/agregar'); ?>" method="post" class="form-horizontal">
        <div class="row-fluid">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="dnombre" id="dnombre" class="span6"
                        value="<?php echo set_value('dnombre'); ?>" maxlength="40" placeholder="Nombre del empacador" required autofocus>
                    </div>
                  </div>
